...
execute if entity @s[scores={NewbLogin=0}] run give @s minecraft:bow{Enchantments:[{id:flame,lvl:1},{id:infinity,lvl:1},{id:power,lvl:4},{id:punch,lvl:2},{id:unbreaking,lvl:3}]}
